...
extension Paths {
    ...
    public struct Fake {
        ...
        public struct GetParameters {
            ...
            public enum EnumQueryStringArray: String, Codable, Hashable, Sendable {
                case greaterThan = ">"
                case dollar = "$"
            }

            public enum EnumQueryString: String, Codable, Hashable, Sendable {
                case abc = "_abc"
                case minusefg = "-efg"
                case xyz = "(xyz)"
            }
        ...
        public func patch(_ body: edgecases_enum_protocols.Client) -> Request<edgecases_enum_protocols.Client> {
